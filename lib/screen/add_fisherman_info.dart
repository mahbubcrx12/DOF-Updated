...
class _AddFisherManState extends State<AddFisherMan> {
  ...
  Future addFisherman() async {
    ...
    request.fields["divisionId"] =selectedDivisionName.toString();
...
//   }
  ...
  void didChangeDependencies() async {
    // TODO: implement didChangeDependencies
     await Provider.of<DivisionProvider>(context).getDivisionData();
setState(() {

});
     await Provider.of<DistrictProvider>(context).getDistrictData();
